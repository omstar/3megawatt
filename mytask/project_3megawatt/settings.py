"""
Django settings for project_3megawatt project.
...
ROOT_URLCONF = 'project_3megawatt.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR + '/mysites', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'project_3megawatt.wsgi.application'
